...
try {
    ...
    if(empty($_POST['shopName']) && ($_POST['sel1'] == '---') && empty($_POST['lowPrice']) && empty($_POST['highPrice']) && empty($_POST['typeMeal']) && empty($_POST['typeCategory']) && empty($_POST['selectCategory'])){
        $_SESSION['flag'] = 'empty';
